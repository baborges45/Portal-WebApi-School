...
{
  public class SmartContext : Microsoft.EntityFrameworkCore.DbContext
  {
    ...
    public DbSet<Aluno> AlunoDisciplinas { get; set; }

    protected override void OnModelCreating(ModelBuilder builder)
    {
      string Text = "05/28/2000";
      ...
      builder.Entity<Cursos>()
          .HasData(new List<Cursos>{
                    new Cursos(1, "Tecnologia da Informação"),
                    new Cursos(2, "Sistemas de Informação"),
                    new Cursos(3, "Ciência da Computação")
          });
      ...
      builder.Entity<Aluno>()
          .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", DateTime.ParseExact(Text,"05/28/2000", CultureInfo.InvariantCulture)),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", DateTime.ParseExact(Text,"05/28/2000", CultureInfo.InvariantCulture)),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", DateTime.ParseExact(Text,"05/28/2000", CultureInfo.InvariantCulture)),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", DateTime.ParseExact(Text,"05/28/2000", CultureInfo.InvariantCulture)),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", DateTime.ParseExact(Text,"05/28/2000", CultureInfo.InvariantCulture)),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", DateTime.ParseExact(Text,"05/28/2000", CultureInfo.InvariantCulture)),
                    new Aluno(7, 7, "Paulo", "José", "9874512", DateTime.ParseExact(Text,"05/28/2000", CultureInfo.InvariantCulture))
          });
